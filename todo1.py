...
class ToDo(object):
	...
	def createToDo(self):
		main = self.root
		todoFRAME = Frame(main,width=600,height=450,bg='#bbbbbb')
		...
		#Add
		del_ = Button(main,text="Delete an item to the list",width=20, height=2, command=lambda:self.showDeletingFrames())
